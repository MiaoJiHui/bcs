  ...
  <body>
    ...
    <div class="page-content">
    	<div class="row">
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li class="current"><a href="<?php echo U('index/editors');?>"><i class="glyphicon glyphicon-pencil"></i> Add Page</a></li>
                    <li class="current"><a href="<?php echo U('index/page_list');?>"><i class="glyphicon glyphicon-pencil"></i> Page Management</a></li>
          ...
          <div class="panel-heading">
            <div class="panel-title">type：<input type="text" id="type"></div>
            <div class="panel-title">name：<input type="text" id="name"></div>
          </div>
          <div class="panel-body">
            <textarea name="financial.bz" id="ckeditor" style="width:200px"></textarea>
          </div>
    ...
    <script type="text/javascript">
      ...
      function upload(){
        ...
        var name = $("#name").val();
        var type = $("#type").val();
        $.post("<?php echo U('Page/upload');?>",{data:data,name:name,type:type},function(a)
              {
                if(a)
                {
                  swal({
                ...
                {
                  swal({
                  title: "The name and type are exist!",   
                  type: "",   
                  timer: 1000,   
                  showConfirmButton: false
                  },function(){
